    ...
    return (
        <div className="flex flex-col items-center justify-center mb-4" style={mainBackgroundStyle}>
            ...
            <div className="text-center mt-8 ">
                <div className="text-orange-700 text-2xl md:text-4xl font-extrabold font-taviraj underline">TAKE ACTION</div>
            </div>

            {/* Image divs */}
            <div className="grid grid-cols-1 px-4 md:grid-cols-2 gap-6 mt-8 mb-5 w-full max-w-screen-lg">
                {/* Image 1 */}
                <motion.div 
